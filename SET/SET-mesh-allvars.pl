...
# Distances are given as input in Aangstrom, but after dimensions-allvars.sh,
# everything is changed into Bohr.
($moleculename,$dist_x,$dist_y,$oxideH,$boxW,$boxH,$boxD) = @ARGV;
...
oxideheight   = $oxideH;
oxidewidth    = $oxideW;
electrodewidth  = $electrode_width;
electrodeheight = $vacuum_height;
