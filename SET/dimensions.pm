...
$vacuum_width    = $xmax-$xmin+2*$AA; # We want 1Å distance from electrodes to nearest nucleus
...
$dist_y  = 1*$AA-$ymin;		# We want 1Å distance from gate to nearest nucleus
...
($Hx,$Hy,$Hz) = ($boxw,$Oxide_H+$dist_y,$boxd);
